...
Copyright (C) Matthew X. Curinga.

This version of _Think Python_ is based on the [_Learning with Python 3 (RLE)_ by Peter Wentworth](http://openbookproject.net/thinkcs/python/english3e/)
